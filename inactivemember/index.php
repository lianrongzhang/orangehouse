...
if(isset($_POST["recover"])){
	if($_POST['member_id']=="")
		echo "<script>Swal.fire({icon: 'error',title: 'Error',text: '請選擇會員編號',showConfirmButton: false,timer: 3000})</script>";
	else{
		$INPUT = [];
		$INPUT[] = "0";
		...
		echo "<script>setTimeout(function(){location.replace('/Talen/inactivefruit/index.php')}, 1500);</script>";
	}
}	
...
function printDiv() {
	...
	style.innerHTML = 'table, th, td {text-align: center;border-collapse:collapse;padding:5px;border-spacing: 1px;border: 1px solid black; font-size: 22px;}';
