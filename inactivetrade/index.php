...
if(isset($_POST["recover"])){
	if($_POST["trade_number"] == "")
		...
		echo "<script>setTimeout(function(){location.replace('/Talen/inactivetrade/index.php')}, 1500);</script>";
	}
}
...
function printDiv() {
	...
	style.innerHTML = 'table, th, td {text-align: center;border-collapse:collapse;font-size:17px;border-spacing: 1px;padding:5px;border: 1px solid black;}';
